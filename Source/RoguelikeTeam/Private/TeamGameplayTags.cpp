...
FTeamGameplayTags FTeamGameplayTags::GameplayTags;

void FTeamGameplayTags::InitializeNativeGameplayTags()
{
	/*
	 * Primary Attributes
	 */
	...
	GameplayTags.Attributes_Secondary_Critical = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Secondary.BlockChance"),
		FString("Chance to cut incoming damage double")
		);
	...
	GameplayTags.Attributes_Secondary_HitRate = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Secondary.CriticalHitDamage"),
		FString("Bonus damage added when a critical hit is scored")
		);

	GameplayTags.Attributes_Secondary_Avoid = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Secondary.CriticalHitResistance"),
		FString("Reduces Critical Hit Chance of attacking enemies")
		);

	GameplayTags.Attributes_Secondary_Wsp = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Secondary.HealthRegeneration"),
		FString("Amount of Attack regenerated every 1 second")
		);
